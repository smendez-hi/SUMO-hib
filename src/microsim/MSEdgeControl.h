...
/// @version $Id: MSEdgeControl.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
public:
    ...
    void patchEdgeFromJunctions(MSJunctionControl *junctions);
    
    void patchSlopes(MSJunctionControl *junctions);
    
    void resolveToJunctionsFromNames(MSJunctionControl *junctions);
    
    void resolveToJunctionsFromNames_(MSJunctionControl *junctions);
