...
/// @version $Id: MSLane.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class MSLane : public Named
{
  ...
  public:
    ...
    MSLane(const std::string& id, SUMOReal maxSpeed, SUMOReal length, MSEdge* const edge,
           ...
           /*   Note: invalidated slope in MSLane constructor can guarantee
            * correct polymorphism with GUILane, which has no slope...
            *   Maybe we should add a slope also to the GUILane constructor if
            * the MSLane construct should have it
            */
    ...
    SUMOReal getMySlope() const;

    void setSlope(SUMOReal myNewSlope);
    ...
    void setNameToJunction(std::string arg);
...
private:
    ...
    // WHICH IS THIS CODE ORGANISATION?
    ...
    class edge_finder
    {
     public:
      ...
      /*
      SUMOReal getMySlope() const;
      void setMySlope(SUMOReal myNewSlope);
      */
     private:
