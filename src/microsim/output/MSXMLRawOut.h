...
/// @date    Mon, 10.05.2004
/// @version $Id: MSXMLRawOut.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class MSXMLRawOut
{
  public:
    ...
    static void writeVehicleFev (OutputDevice& of, SUMOTime timestep, const MSEdge& edge, const MSLane& lane, const MSVehicle& veh);


    static void writeFev(OutputDevice& of, const MSEdgeControl& ec,
                          SUMOTime timestep);
  private:
