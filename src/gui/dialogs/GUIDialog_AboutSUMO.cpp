...
/// @date    Mon, 08.03.2004
/// @version $Id: GUIDialog_AboutSUMO.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
GUIDialog_AboutSUMO::GUIDialog_AboutSUMO(FXWindow* parent,  const char* name, int x, int y)
    ...
    FXLabel *l = new FXLabel(f4, (FXString)"HIB ADAPTED TRAFFIC SIMULATOR", 0,
    ...
    new FXLabel(f3, "Copyright (C) 2001-2012 DLR / Institute of Transportation Systems", 0, LAYOUT_CENTER_X | JUSTIFY_CENTER_X | LABEL_NORMAL, 0, 0, 0, 0, 0, 0, 0, 0);
    new FXLabel(f3, "Copyright (C) 2011-2012 HII / HI iberia Ingenieria y Proyectos S.L.", 0, LAYOUT_CENTER_X | JUSTIFY_CENTER_X | LABEL_NORMAL, 0, 0, 0, 0, 0, 0, 0, 0);
