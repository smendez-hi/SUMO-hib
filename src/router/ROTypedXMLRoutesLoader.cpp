...
/// @date    Sept 2002
/// @version $Id: ROTypedXMLRoutesLoader.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
ROTypedXMLRoutesLoader::ROTypedXMLRoutesLoader
 (RONet& net, SUMOTime begin, SUMOTime end, const std::string& file)
 :ROAbstractRouteDefLoader(net, begin, end), SUMOSAXHandler(file),
...
bool ROTypedXMLRoutesLoader::readRoutesAtLeastUntil(SUMOTime time, bool skipping) {
