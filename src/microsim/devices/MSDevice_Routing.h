...
/// @version $Id: MSDevice_Routing.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
private:
    ...
    MSDevice_Routing
     (SUMOVehicle& holder,const std::string& id,SUMOTime period,
      SUMOTime preInsertionPeriod/*,bool ecoGemRouter*/);
    ...
    /** @brief Returns the non EcoGem effort to pass an edge
     *
     *  This method is given to the used router in order to obtain the non EcoGem
     * efforts to pass an edge from the internal edge weights container.
     *
     ...
     */
    SUMOReal getNonEcoGemEffort(const MSEdge* const e, const SUMOVehicle* const v, SUMOReal t) const;
    
    /** @brief Returns the EcoGem effort to pass an edge
     *
     *  This method is given to the used router in order to obtain the EcoGem
     * efforts to pass an edge from the internal edge weights container.
     *
     *  The time is not used, here, as the current simulation state is
     * used in an aggregated way.
     ...
     * @see DijkstraRouterTT_ByProxi
     */
    SUMOReal getEcoGemEffort(const MSEdge* const e, const SUMOVehicle* const v, SUMOReal t) const;   
...
private:
    ...
    /*
    /// @brief Wether this routing device will be or not EcoGem
    */
    /* static */ /* does not accept this as static? */ /*bool ecoGemRouter;*/
