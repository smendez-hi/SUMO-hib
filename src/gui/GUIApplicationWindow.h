...
/// @date    Sept 2002
/// @version $Id: GUIApplicationWindow.h 11671 2012-01-07 20:14:30Z behrisch $
///
 ...
 */
class GUIApplicationWindow : public GUIMainWindow,
                             public MFXInterThreadEventClient
{
    // FOX-declarations
  ...
  public:
     ...
     * @param[in] ecoGemRouter EcoGem or non EcoGem routing
     */
  ...
  private:
    ...
    void load(const std::string& file, bool isNet, /*bool ecoGemRouter,*/
              bool isReload = false);
  ...
  protected:
    ...
    /// Using EcoGem or non EcoGem routing system
    bool ecoGemRouter;
};
