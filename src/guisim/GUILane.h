...
/// @date    Sept 2002
/// @version $Id: GUILane.h 11671 2012-01-07 20:14:30Z behrisch $
///
 ...
 * visualisation and simulation that may cause problems when vehicles
...
class GUILane : public MSLane
{
  public:
     ...
     * @param[in] slope The slope for this lane
     * @see SUMOVehicleClass
     * @see MSLane
     */
    GUILane(const std::string& id, SUMOReal maxSpeed, SUMOReal length,
