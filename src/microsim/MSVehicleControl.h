...
/// @version $Id: MSVehicleControl.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
public:
    /// @brief Constructor
    MSVehicleControl(bool ecoGemRouterFlag = false) ;
     ...
     */
    virtual SUMOVehicle* buildVehicle
     (SUMOVehicleParameter* defs,const MSRoute* route,
