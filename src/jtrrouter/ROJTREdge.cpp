...
/// @version $Id: ROJTREdge.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
// method definitions
// ===========================================================================
ROJTREdge::ROJTREdge(const std::string& id, RONode* from, RONode* to,
                     unsigned int index, SUMOReal slope)
    : ROEdge(id, from, to, index, false, slope) {}
