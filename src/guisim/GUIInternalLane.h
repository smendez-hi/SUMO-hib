...
/// @date    Thu, 04.09.2003
/// @version $Id: GUIInternalLane.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class GUIInternalLane : public MSInternalLane
{
  public:
     ...
     * @param[in] slope The slope of this lane!
     * @see SUMOVehicleClass
     * @see MSLane
     * @see MSInternalLane
     */
    GUIInternalLane(const std::string& id, SUMOReal maxSpeed, SUMOReal length,
                    MSEdge* const edge, unsigned int numericalID,
                    const PositionVector& shape, SUMOReal width,
                    const SUMOVehicleClasses& allowed,
                    const SUMOVehicleClasses& disallowed, SUMOReal slope = 0);
  ...
  protected:
     ...
     */
    virtual void incorporateVehicle(MSVehicle* veh, SUMOReal pos,
                                    SUMOReal speed,
