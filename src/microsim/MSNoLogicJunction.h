...
/// @version $Id: MSNoLogicJunction.h 11671 2012-01-07 20:14:30Z behrisch $
///
// logic, e.g. for exits.
/****************************************************************************/
...
public:
    ...
    MSNoLogicJunction
     (const std::string& id, const Position& position,
      const PositionVector& shape, std::vector<MSLane*> incoming,
    ...
    const std::vector<MSLane*> getIncLanes(){return myIncomingLanes;}
