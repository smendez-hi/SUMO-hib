...
/// @date    Sept 2002
/// @version $Id: ROEdge.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
public:
     ...
     * @param[in] slope The slope for this edge
    ...
    ROEdge(const std::string& id, RONode* from, RONode* to, unsigned int index,
           bool useBoundariesOnOverride, SUMOReal slope,
     ...
     */
    SUMOReal getEffort(const ROVehicle* const veh, SUMOReal time,
                             bool ecoGemRouter) const ;
...
private:
    ...
    /// @brief This is the edge's slope
    SUMOReal mySlope;
};
