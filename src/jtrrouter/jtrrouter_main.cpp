...
/// @version $Id: jtrrouter_main.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
// Main for JTRROUTER
/****************************************************************************/
 ...
 */
void initNet
 (RONet& net, ROLoader& loader, OptionsCont& oc,
  const std::vector<SUMOReal> &turnDefs)
{
  ...
  for(std::map<std::string, ROEdge*>::const_iterator i = edges.begin();
   i != edges.end();
   ++i)
  {
