...
/// @date    Sept 2002
/// @version $Id: SUMOXMLDefinitions.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
StringBijection<int>::Entry SUMOXMLDefinitions::attrs[] = {
    ...
    { "y",              SUMO_ATTR_Y },
    { "z",              SUMO_ATTR_Z },
    { "height",         SUMO_ATTR_HEIGHT}, // Alias for z...
    ...
    // for capturing vtypes in routes?
    { "mass",			SUMO_ATTR_MASS },
    { "rolling_res",		SUMO_ATTR_ROLLING_RES},
    { "air_density",	SUMO_ATTR_AIR_DENSITY},
    { "frontal_a", 		SUMO_ATTR_FRONTAL_AREA},
    { "drag_coeff", 	SUMO_ATTR_DRAG_COEFFICIENT},
    { "gear_ratio",		SUMO_ATTR_GEAR_RATIO},
    { "gear_sys_eff",	SUMO_ATTR_GEAR_SYS_EFFC},
    { "regen_rat",		SUMO_ATTR_REGEN_RATIO},
    { "motor_eff",		SUMO_ATTR_MOTOR_SYS_EFFC},
    { "cooper_l",		SUMO_ATTR_COOPER_LOSSES},
    { "iron_l",			SUMO_ATTR_IRON_LOSSES},
    { "windage_l",		SUMO_ATTR_WINDAGE_LOSSES},
    { "constant_l",		SUMO_ATTR_CONSTANT_LOSSES},
    { "power_accs",		SUMO_ATTR_POWER_ACCS},
    { "internal_resis",	SUMO_ATTR_INTERNAL_RESIS},
    { "num_cells",		SUMO_ATTR_NUM_CELLS},
    { "capacity",       SUMO_ATTR_CAPACITY },
    { "rate",       SUMO_ATTR_TIME_CHARGE },
    { "temperature",		SUMO_ATTR_ENV_TEMP},
    { "humidity",		SUMO_ATTR_ENV_HUM},
    { "aux_mask",		SUMO_ATTR_AUX_MASK},
    { "ligth_mask",		SUMO_ATTR_LIGHT_MASK},
    { "head_ligth",SUMO_ATTR_HEAD_LIGHT},
    { "front_fog_ligth",SUMO_ATTR_FOG_LIGHT},
    { "cockpit_ligth",SUMO_ATTR_COCKPIT_LIGHT},
    { "radio",SUMO_ATTR_RADIO},
    { "heating_ac",SUMO_ATTR_HEATING_AC},
    {"behaviour", SUMO_ATTR_BEHAVIOUR},
