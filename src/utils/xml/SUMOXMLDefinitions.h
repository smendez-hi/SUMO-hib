...
/// @date    Sept 2002
/// @version $Id: SUMOXMLDefinitions.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
enum SumoXMLAttr {
    ...
    SUMO_ATTR_X,
    SUMO_ATTR_Y,
    SUMO_ATTR_Z, // SHOULD WE USE IT AS THE JUNCTION/CONNECTION HEIGHT?
    SUMO_ATTR_HEIGHT, // ALSO AS HEIGHT
    ...
    SUMO_ATTR_DECEL,
    SUMO_ATTR_MASS,
    SUMO_ATTR_ROLLING_RES,
    SUMO_ATTR_AIR_DENSITY,
    SUMO_ATTR_FRONTAL_AREA,
    SUMO_ATTR_DRAG_COEFFICIENT,
    SUMO_ATTR_GEAR_RATIO,
    SUMO_ATTR_GEAR_SYS_EFFC,
    SUMO_ATTR_REGEN_RATIO,
    SUMO_ATTR_MOTOR_SYS_EFFC,
    SUMO_ATTR_COOPER_LOSSES,
    SUMO_ATTR_IRON_LOSSES,
    SUMO_ATTR_WINDAGE_LOSSES,
    SUMO_ATTR_CONSTANT_LOSSES,
    SUMO_ATTR_POWER_ACCS,
    SUMO_ATTR_INTERNAL_RESIS,
    SUMO_ATTR_NUM_CELLS,
    SUMO_ATTR_CAPACITY,
    SUMO_ATTR_TIME_CHARGE,
    SUMO_ATTR_ENV_TEMP,
    SUMO_ATTR_ENV_HUM,
    SUMO_ATTR_AUX_MASK,
    SUMO_ATTR_LIGHT_MASK,
    SUMO_ATTR_HEAD_LIGHT,
    SUMO_ATTR_FOG_LIGHT,
    SUMO_ATTR_COCKPIT_LIGHT,
    SUMO_ATTR_RADIO,
    SUMO_ATTR_HEATING_AC,
