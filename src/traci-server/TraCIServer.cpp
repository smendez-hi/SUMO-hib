...
/// @date    2007/10/24
/// @version $Id: TraCIServer.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
bool TraCIServer::commandAddVehicle()
{
  ...
  {
    std::cout << "bool TraCIServer::commandAddVehicle()" << std::endl;
  }  
    // read parameters
    ...
    SUMOVehicleParameter* vehicleParams = new SUMOVehicleParameter
     (DEFAULT_VTYPE_ID);
    // Original code was
    //CODE//SUMOVehicleParameter* vehicleParams = new SUMOVehicleParameter();
