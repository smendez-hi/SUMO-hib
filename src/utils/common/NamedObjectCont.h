...
/// @date    Sept 2002
/// @version $Id: NamedObjectCont.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
public:
    ...
    /** @brief Retrieves an item
     *
     * Returns 0 when no item with the given position is stored within the
     *   container
     * @param[in] i The position of the item to retrieve
     * @return The item stored under the given id, or 0 if no such item exists
     */
    /*
    T get(int i) const
