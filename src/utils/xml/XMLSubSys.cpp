...
/// @date    Mon, 1 Jul 2002
/// @version $Id: XMLSubSys.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
bool XMLSubSys::runParser(GenericSAXHandler& handler, const std::string& file)
{
  OptionsCont &oc = OptionsCont::getOptions();
  if(oc.getLoadVerbosity())
    std::cout << "The file to be parsed: "<< file.c_str() << "\n";
    try {
