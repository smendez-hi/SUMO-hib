...
/// @date    07.05.2009
/// @version $Id: TraCIServerAPI_Vehicle.cpp 11680 2012-01-09 14:03:16Z namdre $
///
...
bool TraCIServerAPI_Vehicle::processSet
 (TraCIServer& server, tcpip::Storage& inputStorage,
  tcpip::Storage& outputStorage)
{
  OptionsCont &oc=OptionsCont::getOptions();
  if(oc.getAnyVerbosity()>1)
  {
    std::cout << "bool TraCIServerAPI_Vehicle::processSet(...)" << std::endl;
  }
    std::string warning = ""; // additional description for response
    // variable
    int variable = inputStorage.readUnsignedByte();
    ...
    switch (variable) {
        ...
        case ADD: {
            ...
            SUMOVehicleParameter vehicleParams(DEFAULT_VTYPE_ID);
            // Original code was
            //CODE//SUMOVehicleParameter vehicleParams();
            ...
            SUMOVehicleParameter* params = new SUMOVehicleParameter
             (DEFAULT_VTYPE_ID);
            // Original code was
            //CODE//SUMOVehicleParameter* params = new SUMOVehicleParameter();
