...
/// @date    Mon, 9 Jul 2001
/// @version $Id: MSRouteHandler.h 11671 2012-01-07 20:14:30Z behrisch $
///
 ...
 * their transferring to the MSNet::RouteDict
...
class MSRouteHandler : public SUMOSAXHandler
{
  public:
    ...
    bool checkStopPos
     (SUMOReal& startPos, SUMOReal& endPos, const SUMOReal laneLength,
