...
/// @date    Fri, 30.01.2009
/// @version $Id: MSDevice_Vehroutes.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
{
  public:
    /** @brief Statics intialization
     */
    static void init();

    /** @brief Build devices for the given vehicle, if needed
     *
     *   The options are read and evaluated whether a vehroutes-device shall be
     * built for the given vehicle.
     *   The built device is stored in the given vector.
     *
     * @param[in] v The vehicle for which a device may be built
     * @param[in, filled] into The vector to store the built device in
     */
    static MSDevice_Vehroutes* buildVehicleDevices
