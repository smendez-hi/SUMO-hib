...
/// @author  Laura Bieker
/// @date    Mon, 07.04.2008
/// @version $Id: SUMOVehicleParserHelper.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class SUMOVehicleParserHelper
{
  public:
     ...
     */
    static SUMOVehicleParameter* parseFlowAttributes
     ...
     * @note: the caller is responsible for deleting the returned pointer
     */
    static SUMOVehicleParameter* parseVehicleAttributes
     (const SUMOSAXAttributes& attrs, bool skipID = false,
      bool skipDepart = false);

    /** @brief Starts to parse a vehicle type
     *  @param[in] attrs The SAX-attributes to get vehicle parameter from
     *  @exception ProcessError If an attribute's value is invalid
     *  @see SUMOVTypeParameter
     *  @note: the caller is responsible for deleting the returned pointer
     */
    static SUMOVTypeParameter* beginVTypeParsing
     (const SUMOSAXAttributes& attrs);
     ...
     * @see SUMOVTypeParameter
     */
    static void parseVTypeEmbedded
     ...
     */
    static SUMOVehicleClass parseVehicleClass
     ...
     * @todo Recheck how errors are handled and what happens if they occure
     */
    static SUMOEmissionClass parseEmissionClass
     (const SUMOSAXAttributes& attrs, const std::string& id);
     ...
     * @todo Recheck how errors are handled and what happens if they occure
     */
    static SUMOVehicleShape parseGuiShape
     (const SUMOSAXAttributes& attrs, const std::string& id);
