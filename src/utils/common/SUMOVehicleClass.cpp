...
/// @date    2006-01-24
/// @version $Id: SUMOVehicleClass.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
std::string getVehicleClassNames(const SUMOVehicleClasses& ids) {
...
void parseVehicleClasses
 (const std::string& classNames,SUMOVehicleClasses& container)
{
...
void parseVehicleClasses
 (const std::string& allowedS,const std::string& disallowedS,
  SUMOVehicleClasses& allowed,SUMOVehicleClasses& disallowed)
{
...
const std::string ECOMILE_ELECVTYPE_ID("ECOMILE_ELECVEHTYPE");
const std::string NIDO_ELECVTYPE_ID("NIDO_ELECVEHTYPE");
const std::string MIEV_ELECVTYPE_ID("MIEV_ELECVEHTYPE");
const std::string TEMSA_ELECVTYPE_ID("TEMSA_ELECVEHTYPE");
const std::string DEFAULT_ELECVTYPE_ID("DEFAULT_ELECVEHTYPE");
/* HIB  2015 Jan 22 (samuel) - new electric vehicles */
const std::string DUCATO_ELECVTYPE_ID("DUCATO_ELECVEHTYPE");
const std::string COMARTH_ELECVTYPE_ID("COMARTH_ELECVEHTYPE");
const std::string TRANSIT_ELECVTYPE_ID("TRANSIT_ELECVEHTYPE");
const std::string URBINO_ELECVTYPE_ID("URBINO_ELECVEHTYPE");
