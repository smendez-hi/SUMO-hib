...
/// @date    Mon, 9 Jul 2001
/// @version $Id: NLEdgeControlBuilder.h 11671 2012-01-07 20:14:30Z behrisch $
///
 ...
 * @todo Assignment of lanes is not really well. Should be reworked after shapes
 *  are given as params.
 */
class NLEdgeControlBuilder
{
 ...
 public:
  ...
  /** @brief Adds a lane to the current edge;
    ...
    * @param[in] disallowed Vehicle classes explicitly forbidden on this lane
    * @see SUMOVehicleClass
    * @see MSLane
    * @see MSInternalLane
    * @todo Definitely not a good way
    */
  virtual MSLane* addLane
