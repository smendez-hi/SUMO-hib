...
/// @date    Sept 2002
/// @version $Id: MSLink.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class MSLink
{
  public:
    ...
    void setRequestInformation
     (unsigned int requestIdx, unsigned int respondIdx, bool isCrossing,
      bool isCont, const std::vector<MSLink*> &foeLinks,
     ...
     */
    bool opened
     (SUMOTime arrivalTime, SUMOReal arrivalSpeed, SUMOReal vehicleLength)
      const ;
