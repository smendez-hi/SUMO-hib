...
extern const std::string ECOMILE_ELECVTYPE_ID;
...
extern const std::string DEFAULT_ELECVTYPE_ID;
/* HIB  2015 Jan 22 (samuel) - new electric vehicles */
extern const std::string DUCATO_ELECVTYPE_ID;
extern const std::string COMARTH_ELECVTYPE_ID;
extern const std::string TRANSIT_ELECVTYPE_ID;
