...
/// @date    Mon, 8 Nov 2010
/// @version $Id: MSBaseVehicle.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class MSBaseVehicle : public SUMOVehicle
{
  public:
     ...
     */
    /* Why is const? We have to modify it... */
     ...
     */
    virtual double getPreDawdleAcceleration() const;
    ...
    const MSVehicleType *getMyType() const;
protected:
