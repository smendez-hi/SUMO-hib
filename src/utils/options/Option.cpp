...
/// @version $Id: Option.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
const std::string& Option::getDescription() const { return myDescription; }

void Option::setDescription(const std::string& desc) { myDescription = desc; }

const std::string& Option::getTypeName() const { return myTypeName; }
...
Option_Integer::Option_Integer(int value) : Option(true), myValue(value) {
    myTypeName = "INT";
}
...
Option_Float::set(const std::string& v) {
    try {
    	std::cout << "Value received in Option.set(): " << v.c_str() << "\n";
