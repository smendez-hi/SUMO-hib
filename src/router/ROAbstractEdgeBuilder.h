...
/// @version $Id: ROAbstractEdgeBuilder.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
public:
     ...
     */
    // Original
    virtual ROEdge* buildEdge(const std::string& name, RONode* from, RONode* to,
                              SUMOReal slope) = 0;
    // Try #1
    //CODE//virtual ROEdge* buildEdge(const std::string& name, RONode* from, RONode* to,
    //CODE//                          SUMOReal slope) ;
    // Try #2
    //CODE//virtual ROEdge* buildEdge(const std::string& name, RONode* from, RONode* to,
    //CODE//                          SUMOReal slope) const ;
    // Try #3
    //CODE//virtual ROEdge* buildEdge(const std::string& name, RONode* from, RONode* to,
    //CODE//                          SUMOReal slope) const = 0;
    /// @}
