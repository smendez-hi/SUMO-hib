...
/// @date    Mon, 9 Jul 2001
/// @version $Id: NLBuilder.h 11671 2012-01-07 20:14:30Z behrisch $
///
...
class NLBuilder
{
 ...
 protected:
  ...
  public SAXWeightsHandler::EdgeFloatTimeLineRetriever
  {
   public:
    /// @brief Constructor
    ...
    /** @brief Adds an effort for a given edge and time period
      ...
      */
    void addEdgeWeight
     (const std::string& id, SUMOReal val, SUMOReal beg, SUMOReal end) const;
