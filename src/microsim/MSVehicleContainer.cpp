...
/// @version $Id: MSVehicleContainer.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
 ...
 * ----------------------------------------------------------------------- */
bool MSVehicleContainer::VehicleDepartureVectorSortCrit::operator()
...
bool MSVehicleContainer::DepartFinder::operator()
...
void MSVehicleContainer::add(SUMOTime time, const VehicleVector& cont) {
...
void MSVehicleContainer::addReplacing(const VehicleDepartureVector& x) {
    if (isFull()) {
