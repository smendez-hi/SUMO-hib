...
/// @date    2006-08-01
/// @version $Id: GeoConvHelper.cpp 11671 2012-01-07 20:14:30Z behrisch $
///
...
GeoConvHelper::GeoConvHelper
 (const std::string& proj, const Position& offset, const Boundary& orig,
  const Boundary& conv, int shift, bool inverse, bool baseFound)
 :myProjString(proj),
#ifdef HAVE_PROJ
  myProjection(0),
#endif
